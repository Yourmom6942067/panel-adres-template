...
import {
    RGBColor
} from "../libs/rgbcolor.js";
import {
    console
} from "../libs/console.js";
import {
    buildFontFaceMap,
    parseFontFamily,
    resolveFontFace
            ...
            for (var i = min; i < max + 1; i++) {
                ...
                if (this.ctx.clip_path.length !== 0) {
                    ...
                    this.path = pathPositionRedo(
                        clipPath,
                        this.posX + this.margin[3], -previousPageHeightSum + topMargin + this.ctx.prevPageLastElemOffset
                    );
        ...
        if (this.autoPaging) {
            ...
            for (var i = min; i < max + 1; i++) {
                ...
                if (this.ctx.clip_path.length !== 0) {
                    ...
                    this.path = pathPositionRedo(
                        clipPath,
                        this.posX + this.margin[3], -1 * previousPageHeightSum + topMargin
                    );
                    drawPaths.call(this, "fill", true);
                    this.path = tmpPaths;
                }
                ...
                if (
                    ...
                    if (
                        ...
                        var baseLineRectOnPage = pathPositionRedo(
                            ...
                            this.posX + this.margin[3], -previousPageHeightSum +
                            topMargin +
