...
import {
    saveAs
} from "./libs/FileSaver.js";
import {
    globalObject
} from "./libs/globalObject.js";
import {
    RGBColor
} from "./libs/rgbcolor.js";
import {
    btoa
} from "./libs/AtobBtoa.js";
import {
    console
} from "./libs/console.js";
import {
    PDFSecurity
} from "./libs/pdfsecurity.js";
import {
    toPDFName
} from "./libs/pdfname.js";
/**
            ...
            if (filterAsString.split("/").length - 1 === 1) {
                ...
                for (var j = 0; j < keyValues.length; j += 1) {
                    if (keyValues[j].key === "DecodeParms") {
                        ...
                        for (
                            var i = 0; i < processedData.reverseChain.split("/").length - 1; i += 1
                        ) {
